...
def update_parameters_velocity(parameters, gradients, epoch, velocity, svelocity, beta=0.9, epsilon=1e-8, learning_rate=0.0001, decay_rate=0.01):
    '''
...
def multi_layer_network(X, Y, validation_data, validation_label, net_dims, num_iterations=500, learning_rate=0.0001,
